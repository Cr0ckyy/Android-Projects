...
public class FragmentFirst extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Todo: Advanced Enhancement (Add a button to email the SMS content to your personal email address)
        btnEmail.setOnClickListener((View view12) -> {
            Intent email = new Intent(Intent.ACTION_SEND);

            email.putExtra(Intent.EXTRA_EMAIL,
                    new String[]{"TestEmail@rp.edu.sg"});
        ...
        btnRetrieveNum.setOnClickListener((View view1) -> {
            ...
            @SuppressLint("Recycle") Cursor cursor = cr.query(uri, reqCols, filter, filterArgs, null);
            String smsBody = "";
